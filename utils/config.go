...
func NewConfigurations(logger hclog.Logger) *Configurations {
	...
	viper.SetDefault("ACCESS_TOKEN_PRIVATE_KEY_PATH", "./keys/access-private.pem")
	viper.SetDefault("ACCESS_TOKEN_PUBLIC_KEY_PATH", "./keys/access-public.pem")
	viper.SetDefault("REFRESH_TOKEN_PRIVATE_KEY_PATH", "./keys/refresh-private.pem")
	viper.SetDefault("REFRESH_TOKEN_PUBLIC_KEY_PATH", "./keys/refresh-public.pem")
